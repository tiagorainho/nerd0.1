    ...
    <main class="page users-page">
        <section class="portfolio-block projects-cards">
            <div class="container" align="center">
                  ...
                  <?php
                   if($id_thing==1){ ?>
                    ...
                    <?php }
                        ...
                        <!--<h7 style="color:grey">Adicionar ficheiros</h7>-->
                    <?php }
                    else{
                        echo "erro";
                    }
                ...
                <?php 
                if($id_thing==1){
                    $path="upload_ficheiros_projetos.php?dir=projetos&&nome_projeto=$nome_projeto&&id=1";
                }
                else if($id_thing==2){
                    $path="upload_ficheiros_projetos.php?dir=projetos&&nome_projeto=$nome_projeto&&id=2&&material=$material";
                }
                else{
                    echo "erro";
                }
