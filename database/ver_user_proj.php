<?php
    ...
    if($result==1){
        ...
        $row=mysqli_fetch_array($run_query);
        $imagem_proprio=$row['imagem'];
        $nome_pessoa=$_GET['nome'];
        $nome_projeto=$_GET['projeto'];
        $query="SELECT * FROM data WHERE nome='$nome_pessoa' and active='1'";
        $run_query= mysqli_query($connection,$query);
    ...
    <main class="page users-page">
        <section class="portfolio-block projects-cards">
            <div class="container" align="center">
                ...
                <?php echo "<br><br>" ?>
                <div align="left">
                    <p class="mt-3 mb-0" style="font-size:20px"><a href="project_page.php?nome_projeto=<?php echo $nome_projeto; ?>" class="text-info small">Voltar</a></p>
                </div>
            </div>
        </section>
    </main>
