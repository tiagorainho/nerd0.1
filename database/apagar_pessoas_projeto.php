        ...
        <section class="portfolio-block projects-cards">
            <div class="container" align="center">
                <div class="heading">
                    ...
                    <h7 style ="color:grey">Remover pessoal do projeto</h7>
                </div>        
                ...
                if(isset($_POST["submit"]))
                    if(!empty($_POST['user'])){
                        foreach($_POST['user'] as $user){
                            ...
                            $query_apagar="UPDATE inventario_projetos SET active = '1' WHERE user = '$user'";
                            $run_query_a = mysqli_query($connection,$query_apagar);
                            
                            $query_quem_apagou="UPDATE inventario_projetos SET quem_apagou = '$user' WHERE user = '$user'";
                            $run_query_quem_apagou = mysqli_query($connection,$query_quem_apagou);
                            
                            $query_date="UPDATE inventario_projetos SET date_time = '$today' WHERE user = '$user'";
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']?>?nome_projeto=<?php echo $nome_projeto; ?>" method="post">
                  <?php
                       ...
                       <tr>
                          ...
                          <th style="color:grey" >Dia de aderência</th>
                         </tr>
                          <?php
                           while($row=mysqli_fetch_array($search_users)){
                            ...
                            <!--    <tr class="card-img-top scale-on-hover">    -->
                                <tr>
                                    ...
                                    <td style='width: 120px'><div class="form-check"><input class="form-check-input" type="checkbox" name="user[]" value="<?php echo $row['user']; ?>"><label class="form-check-label" for="formCheck-1"><!-- ALGUM TIPO DE COMMENTARIO  --></label></div></td>
                              
                                  
                                  
                                    <td style='width: 180px' name="user[]" ><?php echo $row['user']; ?></td>
                          ...
                          <?php  
                           ...
                           echo "<p style='color:orange ; font-size:20px'>Projeto sem participantes</p>";
                       }
                       ?>
