        ...
        <div class="row mh-100vh">
            <div class="col-10 col-sm-8 col-md-6 col-lg-6 offset-1 offset-sm-2 offset-md-3 offset-lg-0 align-self-center d-lg-flex align-items-lg-center align-self-lg-stretch bg-white p-5 rounded rounded-lg-0 my-5 my-lg-0" id="login-block">
                <div class="m-auto w-lg-75 w-xl-50">
                    <h2 class="text-info font-weight-light mb-5"><i class="fa fa-diamond"></i>&nbsp;Apagar User</h2>
                    
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
                       
                       
                        <div class="form-group"><label class="text-secondary">Nome do Utilizador</label>
                ...
                if($_SERVER["REQUEST_METHOD"]=="POST"){
                    ...
                    $query="SELECT * FROM data WHERE full_name='$nome'";
                    $run_query= mysqli_query($connection,$query);
                    $result=mysqli_num_rows($run_query);
                    ...
                    if($result==1){
                        ...
                        if($result==1){
                            $query="SELECT * FROM apagar WHERE user='$password'";
                            $run_query= mysqli_query($connection,$query);
                            $result=mysqli_num_rows($run_query);

                            if($result==1){
                                $query_apagar="UPDATE data SET active = '2' WHERE nome = '$nome'";
                                ...
                                if($run_query_a && $run_query){
                                    echo "<p style= color:green>Utilizador &quot$nome&quot apagado</p>";
                                }
                                else{
                                    echo "<p style= color:red>Utilizador &quot$nome&quot não foi apagado</p>";
                                }
                            ...
                            echo "<p style=color:red>Não tens permissão.</p>";
                        }
                        else{
                            ?>
                        ...
                        echo "<p style=color:orange>Utilizador &quot$nome&quot não encontrado</p>";
                    }
                    else{
                        ?>
                        <p style= color:red>BASE DE DADOS CURROMPIDA</p>
            ...
            <div class="col-lg-6 d-flex align-items-end" id="bg-block" style="background-image:url(&quot;assets/img/estrutura/apagar_user.png&quot;);background-size:cover;background-position:center center;">
            </div>
        </div>
    </div>
    <script src="assets/js/jquery.min.js"></script>
